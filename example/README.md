...
4. Take a look at [`Main.elm`](src/Main.elm) to see how to write the necessary code for interacting with a gRPC server! You'll better grasp it from a short example!
